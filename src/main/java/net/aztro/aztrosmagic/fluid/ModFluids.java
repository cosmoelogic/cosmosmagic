package net.aztro.aztrosmagic.fluid;
...
public class ModFluids {
	...
	public static FlowableFluid register(String name, FlowableFluid flowableFluid) {return Registry.register(Registries.FLUID, new Identifier(aztrosmagic.MOD_ID, name), flowableFluid);}
	public static void renderFluids() {
		...
		System.out.printf("%s: Fluids rendered.%n", aztrosmagic.MOD_ID);
	}
}