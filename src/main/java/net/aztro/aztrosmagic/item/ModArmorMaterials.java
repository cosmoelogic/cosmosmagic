...
public class ModArmorMaterials {
	...
	public static void registerArmor() {
		Registry.register(Registries.ITEM, new Identifier(aztrosmagic.MOD_ID, "studded_leather_helmet"), StuddedLeatherItems.STUDDED_LEATHER_HELMET);
		Registry.register(Registries.ITEM, new Identifier(aztrosmagic.MOD_ID, "studded_leather_chestplate"), StuddedLeatherItems.STUDDED_LEATHER_CHESTPLATE);
		Registry.register(Registries.ITEM, new Identifier(aztrosmagic.MOD_ID, "studded_leather_leggings"), StuddedLeatherItems.STUDDED_LEATHER_LEGGINGS);
		Registry.register(Registries.ITEM, new Identifier(aztrosmagic.MOD_ID, "studded_leather_boots"), StuddedLeatherItems.STUDDED_LEATHER_BOOTS);
		...
		System.out.printf("%s: Armor registered.%n", aztrosmagic.MOD_ID);
	}
}