...
import static net.cosmo.cosmosmagic.fluid.ModFluids.AMBROSIA_FLOWING;
import static net.cosmo.cosmosmagic.fluid.ModFluids.AMBROSIA_STILL;

public abstract class AbstractAmbrosiaFluid extends FlowableFluid {
	/**
	 * @return whether the given fluid an instance of this fluid
	 */
	@Override
	public boolean matchesType(Fluid fluid) {
		return fluid == AMBROSIA_STILL || fluid == AMBROSIA_FLOWING;
	}
