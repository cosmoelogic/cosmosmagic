...
public class ModBlockItems {
	...
	public static void registerBlockItems() {
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "glowstone_bricks"), GLOWSTONE_BRICKS);
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "glowstone_brick_stairs"), GLOWSTONE_BRICK_STAIRS);
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "glowstone_brick_slab"), GLOWSTONE_BRICK_SLAB);
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "momentum_crystal_ore"), MOMENTUM_CRYSTAL_ORE);
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "deepslate_momentum_crystal_ore"), DEEPSLATE_MOMENTUM_CRYSTAL_ORE);
		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "momentum_crystal_block"), MOMENTUM_CRYSTAL_BLOCK);
		for (Field field : ModBlockItems.class.getDeclaredFields()) {
			try {
				Object value = field.get(null);
				if (value instanceof Item item) {
					ItemGroupEvents.modifyEntriesEvent(cosmosmagic.BLOCK_ITEM_GROUP).register(content -> content.add(item));
				}
