...
//		Registry.register(Registries.ITEM, new Identifier(cosmosmagic.MOD_ID, "diamond_tipped_iron_pickaxe"), DiamondTippedItems.DIAMOND_TIPPED_PICKAXE);
...
//			}
//		}
//		System.out.printf("%s: Tools registered.%n", cosmosmagic.MOD_ID);
//	}
}
