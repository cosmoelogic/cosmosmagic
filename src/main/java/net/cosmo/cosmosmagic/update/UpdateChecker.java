package net.cosmo.cosmosmagic.update;
...
public class UpdateChecker {
	private static final String MOD_VERSION = cosmosmagic.MOD_VERSION;
	public static void checkForUpdates() {
		try {
			String sURL = "https://raw.githubusercontent.com/cosmo-exe/cosmosmagic-info/main/updater-info.json"; //just a string
